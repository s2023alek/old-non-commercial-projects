...
package lib {
	...
	public class Test000Library {
		...
		//{ =*^_^*= CONSTRUCTOR
		function Test000Library () {throw(new ArgumentError('Library contains images that available through public static properties. Invoke "initialize" static method before using Library.'));}
